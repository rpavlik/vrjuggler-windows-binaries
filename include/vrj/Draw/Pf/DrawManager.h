...
public:
   ...
   /**
    * Returns the Simulator SceneGraph so that vrj::pf::BasicSimulator can
...
public: // Config element handlers
    ...
    */
   virtual bool configCanHandle(jccl::ConfigElementPtr)
   {
      return false;
   }
...
protected:     // --- Config handling functions --- //
    ...
    * @returns false.
    */
   virtual bool configAdd(jccl::ConfigElementPtr)
   {
      vprDEBUG(vprDBG_ALL,vprDBG_CRITICAL_LVL)
         << "[vrj::pf::DrawManager::configAdd()] configAdd is not supported.\n"
         << vprDEBUG_FLUSH;
      return false;
   }
