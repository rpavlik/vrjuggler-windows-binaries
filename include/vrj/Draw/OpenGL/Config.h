...
#ifndef _VRJ_DRAW_OPENGL_CONFIG_H_
#define _VRJ_DRAW_OPENGL_CONFIG_H_
/* #pragma once */

/**
 * \file
 *
 * This file is to be used by code in the OpenGL Draw Manager for ensuring
 ...
 * features for the OpenGL Draw Manager shared library. It must be included at
 * the top of every .h and .cpp file in the OpenGL Draw Manager source
...
#endif   /* _VRJ_DRAW_OPENGL_CONFIG_H_ */
