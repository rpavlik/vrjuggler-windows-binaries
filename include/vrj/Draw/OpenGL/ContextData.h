...
#ifndef _VRJ_OPENGL_CONTEXT_DATA_H_
#define _VRJ_OPENGL_CONTEXT_DATA_H_
...
/** \class vrj::opengl::ContextDataBase ContextData.h vrj/Draw/OpenGL/ContextData.h
 *
 * This class is needed as a base class for ContextData because of dificulties
 * making friends with a template.
 *
 * @note This class for internal use only.
 *
 * @note This class was renamed from vrj::GlContextDataBase in VR Juggler
 *       2.3.11.
 */
...
/** \class vrj::opengl::ContextData ContextData.h vrj/Draw/OpenGL/ContextData.h
 *
 ...
 * {
 *    vrj::opengl::ContextData<myStruct> myData;
 ...
 *
 * @note This class was renamed from vrj::GlContextData in VR Juggler 2.3.11.
 */
template<class ContextDataType = int>
class ContextData : private ContextDataBase
{
public:
   ContextData()
   {;}
