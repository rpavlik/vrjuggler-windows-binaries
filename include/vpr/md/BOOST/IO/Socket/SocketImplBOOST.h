...
#ifndef _VPR_SOCKET_IMPL_BOOST_H_
#define _VPR_SOCKET_IMPL_BOOST_H_
...
/** \class SocketImplBOOST SocketImplBOOST.h vpr/IO/Socket/Socket.h
 *
 * Basic socket wrapper implementation for BOOST sockets.  This is used in
 * conjunction with vpr::SocketConfiguration to create the typedef
 * vpr::Socket.
 */
class VPR_CLASS_API SocketImplBOOST
{
public:
   // ========================================================================
   // vpr::BlockIO basics.
   ...
   vpr::IOSysBOOST::Handle getHandle() const
   {
      return const_cast<vpr::IOSysBOOST::Handle>(this);
   }
   ...
   /**
    * Get and Set for BOOST socket options
    *
...
protected:
  /**
    ...
    */
   SocketImplBOOST(const vpr::SocketTypes::Type sockType);
...
#endif   /* _VPR_SOCKET_IMPL_BOOST_H_ */
