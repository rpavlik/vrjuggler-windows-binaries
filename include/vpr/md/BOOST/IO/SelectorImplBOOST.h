...
#ifndef _VPR_SELECTOR_IMPL_BOOST_H_
#define _VPR_SELECTOR_IMPL_BOOST_H_
...
protected:
    ...
    */
   std::vector<BOOSTPollDesc>::iterator getHandle(const vpr::IOSys::Handle handle);
   std::vector<BOOSTPollDesc>::const_iterator getHandle(const vpr::IOSys::Handle handle) const;

   /// List of poll descriptors to pass to select.
   std::vector<BOOSTPollDesc> mPollDescs;
};

} // End of vpr namespace


#endif /* _VPR_SELECTOR_IMPL_BOOST_H_ */
