...
#ifndef _VPR_SYMBOL_LOOKUP_EXCEPTION_H_
#define _VPR_SYMBOL_LOOKUP_EXCEPTION_H_
...
public:
   ...
   virtual ~SymbolLookupException() throw ();

   virtual std::string getExceptionName() const
   {
      return "vpr::SymbolLookupException";
   }
};
...
#endif /* _VPR_SYMBOL_LOOKUP_EXCEPTION_H_ */
