...
@rem Extend the PATH to include both the bin and lib directories, so DLLs may be found.
@set PATH=%VJ_BASE_DIR%bin;%VJ_BASE_DIR%lib;%PATH%

@rem Run a command prompt that includes the Visual Studio 2008 settings.
@"%VS90COMNTOOLS%..\IDE\devenv"