...
inline void PfAppStats::setStatsMode(PfAppStats::statMode mode)
{
   ...
   switch(mode)
   {
      case PfAppStats::NONE:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to NONE Stats mode.\n" << vprDEBUG_FLUSH;
         break;
      case PfAppStats::FrameTime:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to FrameTime Stats mode.\n" << vprDEBUG_FLUSH;
         break;
      case PfAppStats::Gfx:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to Gfx Stats mode.\n" << vprDEBUG_FLUSH;
         break;
      case PfAppStats::Pipe:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to Pipe Stats mode.\n" << vprDEBUG_FLUSH;
         break;
      case PfAppStats::MPipe:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to MPipe Stats mode.\n" << vprDEBUG_FLUSH;
         break;
      case PfAppStats::Fill:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to Fill Stats mode.\n" << vprDEBUG_FLUSH;
         break;
      default:
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: Switching to unknown Stats mode.\n" << vprDEBUG_FLUSH;
         break;
   }
   ...
   {
      mMPStats.init(120,1);
      vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << clrOutNORM(clrGREEN,"--> MP Stats mode starting!")
...
inline void PfAppStats::preFrame()
{
   ...
   if(mStatsMode == PfAppStats::MPipe)
   {
      ...
      {
         vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << "vjPfAppStats: MP Stats mode done!\n" << vprDEBUG_FLUSH;
   ...
   {
      vprDEBUG(vprDBG_ALL, vprDBG_CRITICAL_LVL) << clrOutNORM(clrGREEN,"vjPfAppStats: mStatsButton pressed. Turning on or cycling stats.\n") << vprDEBUG_FLUSH;
